"""
Verify: Strategic Deception as Entropy Injection
=================================================

Theorems 8-10, Definitions 12-18, Corollary 10.1.

Validates all numerical claims in case-studies/deception-entropy.md
using both symbolic (SymPy) and numerical (NumPy) computation.

Run:  python scripts/simulations/applied/verify_deception_entropy.py
"""
...
if __name__ == "__main__":
    ...
    # Deceiver reward maximized at q = 0
    ...
    check("Deceiver reward maximized at q = 0",
    ...
    # FIGURE DATA EXPORT
    # -------------------------------------------------------------------
    section("FIGURE DATA — Deception Entropy")
