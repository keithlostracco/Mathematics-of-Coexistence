"""
Verify: Why Rational Agents Preserve the Biosphere
====================================================

Theorems 17–21, Definitions 27–34, Propositions 5–7, Corollaries 18.1, 19.1.

Validates all numerical claims in case-studies/biosphere-preservation.md
using both symbolic (SymPy) and numerical (NumPy) computation.

Run:  python scripts/simulations/applied/verify_biosphere_preservation.py
"""
...
if __name__ == "__main__":
    ...
    # ===================================================================
    section("13. Energy Budget Comparison")
    # ===================================================================
    ...
    # The math file says the comparison is "total energy over 1000 years"
    ...
    # using 10^29 J over 4 Gyr. An agent with a Dyson swarm has more raw energy,
    ...
    # FIGURE DATA EXPORT
    # -------------------------------------------------------------------
    section("FIGURE DATA — Burning Library")
