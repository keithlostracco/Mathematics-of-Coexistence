"""
Verify: AI Foundation Model Ecosystem Collapse — Dual-Channel Cascade
======================================================================

Independently validates every numerical claim in the foundation model
...
Run:
    python scripts/simulations/ai-applications/verify_ai_foundation_collapse.py
"""
...
if __name__ == "__main__":
    ...
    section("1. Foundation Model Scenario Parameters")
    ...
    # FIGURE DATA EXPORT
    # -------------------------------------------------------------------
    section("FIGURE DATA — AI Foundation Collapse")
    ...
    scenarios_fig = [
        ...
        {"fail_times": {"F_gamma": 5}, "data_contamination_time": None},
        {"fail_times": {"F_gamma": 5}, "data_contamination_time": 10},
    ]
